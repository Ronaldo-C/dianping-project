...
import { getProductDetail, getProductById, schema as productSchema } from './entities/products'
...
export const types = {
  ...
  // 获取关联店铺信息
  FETCH_SHOP_REQUEST: 'DETAIL/FETCH_SHOPS_DETAIL_REQUEST',
  FETCH_SHOP_SUCCESS: 'DETAIL/FETCH_SHOPS_DETAIL_SUCCES',
  FETCH_SHOP_FAILURE: 'DETAIL/FETCH_SHOPS_DETAIL_FAILURE',
}
